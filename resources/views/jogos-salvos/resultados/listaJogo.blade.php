...
<div class="container-fluid">
	<div class="row-fluid">
		<h2>Apostas dos jogos salvos</h2>

		<hr />

		<div class="block-content collapse in">
			<form action="{{ route('listaPorConcurso') }}" method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
				<input type="text" value="{{$qualJogo}}" name="qualJogo" style="display: none">
				<input type="text" value="{{$codigo}}" name="codigo" style="display: none">
				<div class="span3" align="center"> 
					<div class="control-group success">
                      	<div class="controls">
                        	<select id="selectError" name="idConcurso">
                          		<option>Seleciona um concurso para conferir</option>
                          		@foreach($arrayDezJogos as $arr)
                          			<option value="{{ $arr->id }}">Concurso {{$arr->numero_concurso}} - {{$arr->	data_sorteio}}</option>
                          		@endforeach
                          	</select>
                      	</div>
                    </div>
				...
				<div class="span4" align="center"> 
					<input type="submit" class="btn btn-large btn-block btn-primary" value="Conferir resultado!" />
				</div>
				<div class="span4" align="center">
					<a href="{{ url('pdfCentral', $codigo) }}" class="btn btn-large btn-block btn-success">Exportar jogo para PDF!</a>
				</div>
			</form>
		</div>
		
		@if(!empty($arrayValoresJogos))
		<div class="block">
			<div class="block-content collapse in">
				<p style="color: red;">Concurso de numero: <b>{{$numeroJogo}}</b> do dia: <b>{{$dataConcurso}}</b></p>
			</div>
		</div>
		<div class="block">
			<div class="block-content collapse in">
		...
		<hr style="height:2px; border-width:0; color:gray; background-color:red; margin-top:5px; margin-botton:5px;">
