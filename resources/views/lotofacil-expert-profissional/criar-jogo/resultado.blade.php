	...
	<div class="row-fluid">
		...
		<div class="block">
			<div class="collapse in">
				...
				<div class="span6" align="center">
					<a href="{{ url('pdfCinco', $codigo) }}" class="btn btn-large btn-block btn-success">Exportar jogo para PDF!</a>
				</div>
			</div>
		</div>

		<h2>Principais apostas</h2>

		<p>Baseadas em cálculos matemáticos, abaixo estão as todas as apostas. É importante ressaltar que a garantia funciona apenas ao realizar todas as apostas geradas pelo sistema, caso os 5 números escolhidos não sejam sorteados.</p>
