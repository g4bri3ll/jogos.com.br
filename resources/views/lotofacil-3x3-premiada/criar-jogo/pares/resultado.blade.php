...
<div class="container-fluid">
	<div class="row-fluid">
		...
		<p>Com base nos números escolhidos nas etapas anteriores, o sistema gerou as apostas abaixo.</p>
		<p>É necessário que ao menos 9 números entre os 12 escolhidos sejam sorteados no próximo concurso, para que haja premiação.</p>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$arrayValoresJogos['premio'][$i]}}</td>
                                </tr>
                                @endfor
                            </tbody>
                        </table>
		...
		<a href="{{ url('salvaJogoUsers', $codigo) }}" type="button" class="btn btn-large btn-block btn-primary">Salvar este jogo!</a>
		<br />
        <?php $i = 1; $cor = "#F0E68C"; ?>
